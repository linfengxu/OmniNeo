...
parser.add_argument('-f', '--fasta-path', type=str, default='/home/chen.alb/FASTA/swissprot_human_20180730.fasta', help='Path to FASTA file')
parser.add_argument('-s', '--scratch-folder', type=str, default='/tmp', help='Base scratch folder for output')
...
output_folder = os.path.join(args.scratch_folder, output_folder)
